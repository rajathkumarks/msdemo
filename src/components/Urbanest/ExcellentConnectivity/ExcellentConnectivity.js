  ...
  const ExcellentConnectivityData = [
    {
      ...
      desc: "Urbanest is conveniently tucked away from the concrete jungle, yet in close proximity to IT Hubs, schools, hospitals, and entertainment spaces. Being located at Sompura gate, Sarjapur road, you can easily get to the places that matter the most to you in under 30 minutes. ",
      // button: "View on map",
